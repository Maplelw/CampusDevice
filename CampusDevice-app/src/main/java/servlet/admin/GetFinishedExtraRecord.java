...
@WebServlet("/admin/getFinishedExtraRecord")
public class GetFinishedExtraRecord extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (result.containsKey("openid"))
        {
            ...
            info = adminService.getFinishedExtraRecord(wechatID, page ,10);
        }
        //请求失败，返回错误信息
        else
        {
