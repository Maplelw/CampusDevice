...
public interface AdminService
{
     ...
     * @return
     */
    JSONObject addExtraInfo(String name,String infos,String d_no,String wechatID);
     ...
     * @return
     */
    JSONObject setReturned(int ei_no);
     ...
     * @return
     */
    JSONObject getFinishedExtraRecord(String wechatID,int page,int count);
     ...
     * @return
     */
    JSONObject getUnfinishedExtraRecord(String wechatID,int page,int count);
}
