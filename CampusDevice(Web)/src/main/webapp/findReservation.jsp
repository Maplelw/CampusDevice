                            ...
                            <div class="table-responsive">
                                ...
                                <nav aria-label="Page navigation example" class="text-center" >
                                    <ul class="pagination justify-content-center" id="mytab">
                                        ...
                                        %>
                                        <li class="page-item">
                                            <a class="page-link" href="findrsrv.action?page=<%=pages%>&sp=<%=startpage-1%>" >&laquo;</a>
                                        </li>
                                        <%
                                            }
                                        ...
                                        <li class="active page-item" aria-current="page">
                                            <a class="page-link" href="findrsrv.action?page=<%=i%>"><%=i%></a>
                                        </li>
                                        <%
                                        }
                                        else
                                        ...
                                        %>
                                        <li class="page-item">
                                            <a class="page-link" href="findrsrv.action?page=<%=pages%>&sp=<%=startpage+1%>">&raquo;</a>
                                        </li>
                                        <%
                                            }
                                        %>
