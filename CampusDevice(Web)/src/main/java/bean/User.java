...
public class User
{
    ...
    public User(String u_no, String u_name, String u_wechatID, String u_email, String u_phone, int u_creditGrade, String u_type, String u_mentorName, String u_mentorPhone, int s_no,String s_name)
    {
        this.u_no = u_no;
        this.u_name = u_name;
    ...
    public User(String u_no, String u_name, String u_wechatID, String u_email, String u_phone, int u_creditGrade, String u_type, String u_mentorName, String u_mentorPhone, int s_no)
    {
        this.u_no = u_no;
        this.u_name = u_name;
        this.u_wechatID = u_wechatID;
