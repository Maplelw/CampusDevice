...
public class Device {
    ...
    public Device(String d_no, String a_no, String d_state, int d_borrowedTimes, String d_name,
                  String d_saveSite,String d_factoryNo,String d_storeDate,String d_model)
    {
        this.d_no = d_no;
        this.a_no = a_no;
        this.d_state = d_state;
